...
<div class="w-full bg-green-200 p-10 rounded-xl shadow-xl hover:scale-105 transition duration-300 group z-30">
	<h3 class="mb-4 text-2xl font-medium text-gray-600 flex justify-center">{name}</h3>
	...
	<button
		class="bg-green-700 text-white transition-all rounded-lg text-lg p-2 w-full group-hover:bg-green-800"
		>Choose Plan</button
	>
</div>
