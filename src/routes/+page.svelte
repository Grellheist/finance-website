...
<ScrollToTop />
<div
	class="flex flex-col gap-12 items-center justify-center p-12 mb-12 bg-[#FEFDF9] select-none"
	id="tutorial"
>
...
<div
	class="flex flex-col gap-12 items-center justify-center p-12 bg-[#EDFDF2] select-none"
	id="reviews"
>
	<h2
